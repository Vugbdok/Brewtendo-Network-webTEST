function load_04() {
	return `
		<div class="navi-bar">
			...
			<img src="old-site/meta/images/MiiTeamData/FounderTeam.png" width="300" alt="Founder"/>
			<img src="old-site/meta/images/MiiTeamData/OwnerTeam.png" width="300" alt="Owner"/>
