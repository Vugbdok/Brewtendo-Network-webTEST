function load_1() {
	return `
            ...
            <div id="center-div">
                ...
                <div class="style-center-div-black" id="float">Brewtendo is a Nintendo Network revival for the 3DS, it's not really trying to be a potential Pretendo rival, however. Instead it revives the things that they wouldn't add such as the eShop, Badge Arcade, Theme Shop, and Nintendo Video.<wbr />(devs lmk if i missed anything or you want me to add / change to this.)<img width="70" src="https://brewtendonetwork.github.io/meta/images/eShop.png" /><wbr />If you live under a rock and want insight to why the eShop shut down in 2023 then look <a style="color:#f2f2f2;" href="https://en-americas-support.nintendo.com/app/answers/detail/a_id/57847/~/wii-u-%26-nintendo-3ds-eshop-discontinuation-q%26a">here</a></div>
            </div>
    `;
}
